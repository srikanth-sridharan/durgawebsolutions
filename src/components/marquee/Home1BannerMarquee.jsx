      ...
      <div className="home1-banner-bottom mb-110">
        <Marquee>
          <div className="marquee_text">
            ...
            <h6>Welcome to Durga Web Solutions</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Fueling your digital dreams.</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Innovation with a purpose.</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
            ...
            <h6>Smarter technology for a better tomorrow.</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={17}
              height={17}
